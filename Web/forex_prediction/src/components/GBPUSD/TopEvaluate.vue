      ...
      <div class="tile">
        <div class="tile is-parent">
          <article class="tile is-child box">
            <p class="subtitle is-5 has-text-grey-light">MAE</p>
            <div class="columns">
        ...
        <div class="tile is-parent">
          <article class="tile is-child box">
            <p class="subtitle is-5 has-text-grey-light">R2 Score</p>
            <div class="columns">
              <div class="column is-two-thirds">
                <div>
              ...
              <div class="column">
                <span>
                  <p class="title is-3 has-text-weight-bold " style="color: #8162E1">
                    <var>R<sup> 2</sup></var>
                  </p>
                </span>
              </div>
        ...
        <div class="tile is-parent">
          <article class="tile is-child box">
            <p class="subtitle is-5 has-text-grey-light">Trend Accuracy</p>
            <div class="columns">
              <div class="column is-two-thirds">
...
export default {
  ...
  methods: {
    ...
    //     this.MAE = res.MAE
    //     this.R2_score = res.R2_SCORE
    //     this.Trend_acc = res.Slope_acc
    //   } catch (error) {
    //     console.log(error);
    //   }
    // },
